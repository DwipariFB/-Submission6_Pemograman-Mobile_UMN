package umn.ac.id.week06a_65054;
...
public class ViewAnimas extends View {
    ...
    public ViewAnimas(Context context) {
        super(context);
    }

    public ViewAnimas(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public ViewAnimas(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
    }

    public ViewAnimas(Context context, @Nullable AttributeSet attrs, int defStyleAttr, int defStyleRes) {
